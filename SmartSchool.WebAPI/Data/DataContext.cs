...
namespace SmartSchool.WebAPI.Data
{
    public class DataContext : DbContext
    {
        ...
        {
            builder.Entity<AlunoDisciplina>().HasKey(AD => new { AD.AlunoId, AD.DisciplinaId }); // cria no banco uma referencia de muitos pra muitos
            builder.Entity<AlunoCurso>().HasKey(AD => new { AD.AlunoId, AD.CursoId }); // cria no banco uma referencia de muitos pra muitos

            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, 1, "Lauro", "Oliveira", "123456789"),
                    new Professor(2, 2, "Roberto", "Soares", "123456789"),
                    new Professor(3, 3, "Ronaldo", "Marconi", "123456789"),
                    new Professor(4, 4, "Rodrigo", "Carvalho", "123456789"),
                    new Professor(5, 5, "Alexandre", "Montana", "123456789"),
                });
